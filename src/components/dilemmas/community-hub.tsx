          ...
          >
            {activeTab === "dilemmas" && (
              <motion.div
                ...
                className="border-border-subtle/50 absolute inset-0 rounded-full border bg-white/5 shadow-inner"
          ...
          >
            <div className="border-border-subtle/30 flex flex-wrap items-center justify-between gap-4 border-b pb-4">
              ...
              <Link href="/suggestions/new">
                <Button size="sm" leftIcon={<Plus className="h-4 w-4" aria-label="Add" />}>
