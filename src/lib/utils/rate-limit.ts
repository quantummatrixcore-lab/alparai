...
export const RATE_LIMIT_KEYS = {
  ...
  watches: "ratelimit:watches",
  user_deletion: "ratelimit:user_deletion",
  verify_incident: "ratelimit:verify_incident",
  voice_incident: "ratelimit:voice_incident",
  report_flagging: "ratelimit:report_flagging",
  email_preferences: "ratelimit:email_preferences",
  challenge_vote: "ratelimit:challenge_vote",
  challenge_submission: "ratelimit:challenge_submission",
  incident_analyze: "ratelimit:incident_analyze",
  cookie_consent: "ratelimit:cookie_consent",
  funnel_event: "ratelimit:funnel_event",
  upload_evidence: "ratelimit:upload_evidence",
  billing_invoice: "ratelimit:billing_invoice",
} as const;
...
function getLimiters(): Record<string, Ratelimit> {
  ...
  _limiters = {
    ...
    [RATE_LIMIT_KEYS.admin_advisor_chat]: new Ratelimit({
      redis: _redis,
      limiter: Ratelimit.slidingWindow(20, "1 h"),
      analytics: true,
      prefix: "alpar",
    }),
    [RATE_LIMIT_KEYS.watches]: new Ratelimit({
      redis: _redis,
      limiter: Ratelimit.slidingWindow(30, "1 m"),
      analytics: true,
      prefix: "alpar",
    }),
    [RATE_LIMIT_KEYS.user_deletion]: new Ratelimit({
      redis: _redis,
      limiter: Ratelimit.slidingWindow(3, "1 d"),
      analytics: true,
      prefix: "alpar",
    }),
    [RATE_LIMIT_KEYS.verify_incident]: new Ratelimit({
      redis: _redis,
      limiter: Ratelimit.slidingWindow(10, "1 m"),
      analytics: true,
      prefix: "alpar",
    }),
    [RATE_LIMIT_KEYS.voice_incident]: new Ratelimit({
      redis: _redis,
      limiter: Ratelimit.slidingWindow(5, "1 h"),
      analytics: true,
      prefix: "alpar",
    }),
    [RATE_LIMIT_KEYS.report_flagging]: new Ratelimit({
      redis: _redis,
      limiter: Ratelimit.slidingWindow(5, "1 h"),
      analytics: true,
      prefix: "alpar",
    }),
    [RATE_LIMIT_KEYS.email_preferences]: new Ratelimit({
      redis: _redis,
      limiter: Ratelimit.slidingWindow(10, "1 m"),
      analytics: true,
      prefix: "alpar",
    }),
    [RATE_LIMIT_KEYS.challenge_vote]: new Ratelimit({
      redis: _redis,
      limiter: Ratelimit.slidingWindow(20, "1 m"),
      analytics: true,
      prefix: "alpar",
    }),
    [RATE_LIMIT_KEYS.challenge_submission]: new Ratelimit({
      redis: _redis,
      limiter: Ratelimit.slidingWindow(5, "1 h"),
      analytics: true,
      prefix: "alpar",
    }),
    [RATE_LIMIT_KEYS.incident_analyze]: new Ratelimit({
      redis: _redis,
      limiter: Ratelimit.slidingWindow(15, "1 m"),
      analytics: true,
      prefix: "alpar",
    }),
    [RATE_LIMIT_KEYS.cookie_consent]: new Ratelimit({
      redis: _redis,
      limiter: Ratelimit.slidingWindow(30, "1 m"),
      analytics: true,
      prefix: "alpar",
    }),
    [RATE_LIMIT_KEYS.funnel_event]: new Ratelimit({
      redis: _redis,
      limiter: Ratelimit.slidingWindow(60, "1 m"),
      analytics: true,
      prefix: "alpar",
    }),
    [RATE_LIMIT_KEYS.upload_evidence]: new Ratelimit({
      redis: _redis,
      limiter: Ratelimit.slidingWindow(10, "1 h"),
      analytics: true,
      prefix: "alpar",
    }),
    [RATE_LIMIT_KEYS.billing_invoice]: new Ratelimit({
      redis: _redis,
      limiter: Ratelimit.slidingWindow(5, "1 h"),
      analytics: true,
      prefix: "alpar",
