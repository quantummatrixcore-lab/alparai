...
import type { SocialPost, SocialTemplate, SocialAsset, SocialAccount } from "@/types/social";
...
export async function getSocialTemplates(): Promise<SocialTemplate[]> {
  try {
    ...
    console.error("[getSocialTemplates] Error:", err);
    throw err;
  }
}
...
export async function getSocialAssets(): Promise<SocialAsset[]> {
  try {
    ...
    console.error("[getSocialAssets] Error:", err);
    throw err;
  }
}
...
export async function getMarketingDrafts(): Promise<unknown[]> {
  try {
    ...
    console.error("[getMarketingDrafts] Error:", err);
    throw err;
  }
}
...
export async function publishDraftToLinkedInAction(
  ...
  try {
    ...
    console.error("[publishDraftToLinkedInAction] Error:", err);
    throw err;
  }
}
