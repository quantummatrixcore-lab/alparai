  ...
  return (
    <Section className="bg-bg-secondary/30">
      <Container>
        ...
        >
          <h2 className="text-fg-primary text-2xl font-bold sm:text-3xl">
            {t("join_title")}
          </h2>
                    ...
                    <div>
                      <CardHeader className="pb-2">
                        <div className="flex items-center justify-between">
                          ...
                          {cta.tagKey && (
                            <span className="text-fg-secondary border-border-subtle/50 rounded-full border bg-white/5 px-2 py-0.5 text-[10px] font-bold tracking-wider uppercase">
                              {t(cta.tagKey)}
                            </span>
                          )}
                        </div>
