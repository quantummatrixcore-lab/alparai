...
export function TrustBar() {
  ...
  const items = [
    {
      icon: Github,
      label: t("open_source"),
      href: "https://github.com/quantummatrixcore-lab/alparai?ref=alparai",
    },
  ...
  return (
    <div className="animate-fade-up border-border-subtle flex flex-wrap justify-center gap-6 border-y bg-white/5 px-8 py-4 opacity-0 backdrop-blur-md">
      {items.map((item) => (
        <Link
          key={item.label}
          href={item.href}
