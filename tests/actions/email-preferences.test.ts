...
vi.hoisted(() => {
  ...
  vi.doMock("@/lib/auth/session", () => ({
    requireAdmin: vi.fn().mockResolvedValue({ id: "user-1", role: "user" }),
    requireUser: vi.fn().mockResolvedValue({ id: "user-1", role: "user" }),
    getCurrentUser: vi.fn().mockResolvedValue({ id: "user-1", role: "user" }),
  }));
});
