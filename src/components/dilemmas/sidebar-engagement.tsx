    ...
    <aside className="flex w-full flex-col gap-4 lg:w-[300px]">
      ...
      {poll && (
        ...
        >
          ...
          <h3 className="text-fg-primary mb-4 text-sm leading-snug font-bold">
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <div className="bg-bg-tertiary relative h-4 flex-1 overflow-hidden rounded-sm">
        ...
        />
        {pct > 0 && (
          <span className="text-fg-secondary absolute top-1/2 right-1 -translate-y-1/2 text-[10px] font-bold">
            %{pct}
          </span>
        )}
      </div>
