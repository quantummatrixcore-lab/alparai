...
// 1c. POST /api/v1/incidents/voice
export const voiceIncidentResponseSchema = z.object({
  success: z.boolean(),
  data: z
    .object({
      ...
      languages_supported_count: z.number(),
      confidence: z.number(),
      duration_seconds: z.number(),
      asr_engine: z.string(),
      pii_masked: z.boolean(),
      pii_categories_redacted: z.array(z.string()),
    })
    .optional(),
